#ifndef SHELLCORE_PATCHES_13_40
#define SHELLCORE_PATCHES_13_40

static struct shellcore_patch shellcore_patches_1340_retail[] = {
    ...
    {0x6CC781, "\xeb", 1}, // preLaunchCheck
    {0x6CCA12, "\xeb", 1}, // category check
    {0x6CCCD9, "\xeb", 1}, // workspace category check
...
static struct shellcore_patch shellcore_patches_1340_testkit[] = {
};

static struct shellcore_patch shellcore_patches_1340_devkit[] = {
};

#endif // SHELLCORE_PATCHES_13_40